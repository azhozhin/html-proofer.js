...
program.
    ...
    //.syntax 'htmlproofer.js PATH [options]'

    .description('Runs the HTML-Proofer suite on the files in PATH. For more details, see the README.').
    option('--allow-hash-href',
        'If `true`, assumes `href="#"` anchors are valid',
        true).
    option('--allow-missing-href',
    ...
    option('--check-sri',
        ...
        false).
    option('--directory-index-file <filename>',
    ...
    option('--swap-attributes CONFIG',
        ...
        '{}').
    option('--swap-urls re:string,[re:string,...]',
