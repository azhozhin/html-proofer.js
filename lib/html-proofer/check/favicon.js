...
import {adapt_nokogiri_node} from '../utils.js'
...
export class Favicon extends Check {
  ...
  immediate_redirect() {
    const content = this.html.xpath('//*[local-name(.)="meta" and @http-equiv="refresh"]/@content')
    if (!content || content.length === 0) {
      return false
    }

    return content[0].value.startsWith('0;')
  }
}