...
export class Url extends Attribute {
    ...
    get file_path(){
        ...
        // either overwrite with root_dir; or, if source is directory, use that; or, just get the current file's dirname
            base = this.runner.options['root_dir'] || (isDirectory(this.runner.current_source) ? this.runner.current_source : path.dirname(this.runner.current_source))
        ...
        } else if (fs.existsSync(path.join(path.dirname(this.runner.current_filename), this.path)) || fs.existsSync(path.join(path.dirname(this.runner.current_filename), path_dot_ext))){
            base = path.dirname(this.runner.current_filename)
